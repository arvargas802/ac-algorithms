...
function alphabetSoup(str) {
	var stringToSort = str ;
  var splitString = stringToSort.split("");
  var sortString = splitString.sort();
  var joinedArray = sortString.join(" ");
	console.log(joinedArray);	
}

alphabetSoup("hello ari");


function alphabetChained(str) {
 
    var answer = str.split("").sort().join("");
  console.log(answer)
}
  alphabetChained("great work everyone");
